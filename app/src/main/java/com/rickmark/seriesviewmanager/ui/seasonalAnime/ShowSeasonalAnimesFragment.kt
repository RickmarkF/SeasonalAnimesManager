...
class ShowSeasonalAnimesFragment : Fragment(R.layout.fragment_show_seasonal_animes) {
    ...
    private val viewModel: SeasonalAnimeViewModel by activityViewModels()

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val seasonalAnimeList: List<Data>? = viewModel.loadSeasonalAnimesIfNeeded()
        ...
        if (seasonalAnimeList != null) {
            temporada.text = "Temporada: ${viewModel.getSeason()}\n Año:${viewModel.getYear()}"
